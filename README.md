...
|4 |[Modernize Your Data Warehouse](../amazon-redshift-modernize-dw#connecting-to-the-cluster) |Query petabytes of data in your data warehouse and exabytes of data in your S3 data lake, using Redshift Spectrum |
